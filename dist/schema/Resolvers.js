...
const testImages = {
    images: [
        {
            id: "1",
            url: "https://cdn.apartmenttherapy.info/image/upload/v1654009408/at/living/2022-06/yard%20sales/yard_sale.jpg",
            yardSaleId: "1",
        },
        {
            id: "2",
            url: "https://patch.com/img/cdn20/users/22887534/20230519/072601/styles/patch_image/public/file___19192053061.jpg",
            yardSaleId: "2",
        },
        {
            id: "3",
            url: "https://gray-wfie-prod.cdn.arcpublishing.com/resizer/v2/AJ5GU22LVZEHHCYPOXWNVYVUGI.jpg?auth=ae25edfab065cdeeb4233d3ae0d52a6a359350bef0e0973b1d8ac9665fef6439&width=800&height=450&smart=true",
            yardSaleId: "3",
        },
        {
            id: "4",
            url: "https://bloximages.newyork1.vip.townnews.com/thepostnewspapers.com/content/tncms/assets/v3/editorial/a/1e/a1ef3cc7-01c4-5f4d-b8ba-453f382b3585/51c21916914b5.image.jpg?resize=667%2C500",
            yardSaleId: "4",
        },
        {
            id: "4",
        ...
        {
            id: "6",
            url: "https://s.hdnux.com/photos/01/33/25/75/23945029/3/1200x0.jpg",
            yardSaleId: "2",
        },
    ],
};
...
export const resolvers = {
    Query: {
        ...
        yardSales: () => testYardSales.yardsales,
        addresses: () => testAddresses.address,
        images: () => testImages.images,
        tags: () => testTags.tags,
        yardSale: async (parent, args, context, info) => {
            const id = args.id; // Assuming you're fetching by id
            const image = await resolvers.Query.testImage(parent, { id }, context, info);
            const address = await resolvers.Query.testAddress(parent, { id }, context, info);
            const tags = await resolvers.Query.testTags(parent, { id }, context, info);
            return {
                id,
                image,
                address,
